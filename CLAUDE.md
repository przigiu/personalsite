...
- Card: `flex flex-col h-[310px] md:h-[360px] gap-2 pb-[19px]` — `h-[310px]` on mobile, `h-[360px]` on tablet+. NO `justify-end` (image fills from top). **When 4+ projects are visible and the grid restores to 4-column desktop layout (see homepage section), revert card height to `h-[277px] md:h-[246px]` (original Figma values) — at ~295px card width the 4:3 images fill the container naturally without needing extra height.**
