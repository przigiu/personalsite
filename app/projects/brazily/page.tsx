      ...
      >
        ...
        <div className="flex flex-col gap-[24px]">
          ...
          <div className="pt-[12px]">
            <a href="https://github.com/przigiu/claudeskills" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-[6px] font-normal text-[14px] leading-[13.82px] text-black/75 border-b border-black/75">
              View the
